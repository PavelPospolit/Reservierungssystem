...
import com.trainee.rs.actions.Random_Number_Generator;
import com.trainee.rs.ressources.*;
    ...
    public static void addComponentsToPane(Container pane) {
        ...
        button = new JButton(new AbstractAction("Anlegen") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(frame, "com.trainee.rs.Classes.Mitarbeiter erfolgreich hinzugefügt.");
                frame.dispose();
