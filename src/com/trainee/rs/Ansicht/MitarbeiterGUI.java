    ...
    public static void addComponentsToPane(Container pane) {
        ...
        button = new JButton(new AbstractAction("Eingabe") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(!bMA){
                    JOptionPane.showMessageDialog(frame,"com.trainee.rs.Classes.Mitarbeiter bereits vorhanden, bitte anderen Benutzernamen wählen (evtl. Nachname mit einfügen)");
                    frame.dispose();
                    createAndShowGui();
                }
                else{
